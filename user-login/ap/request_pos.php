...
<div class="tabs">
    <div id="tab-1" class="tab">
        <h1>Request for POs</h1>
        <h5>Filtering Options.</h5>
        <form action="request_pos.php" method="POST">
        ...
        <table class="data display datatable" id="example">
            <article>
                ...
                if (isset($_POST['submit'])) {
                    $query = "SELECT * FROM payment WHERE status='approved' and branch_code like '%" . $_SESSION['branch'] . "%' and date>='" . $_POST['from'] . "' and date<='" . $_POST['to'] . "'";
                } else {
                    $query = "SELECT * FROM payment WHERE status='approved' and branch_code like '%" . $_SESSION['branch'] . "%'";
                }
