...
<div class="tabs">
    <div id="tab-1" class="tab">
        ...
        <form action="paid_pos.php" method="POST">
        ...
        <table class="data display datatable" id="example">
            <article>
                ...
                if (isset ($_POST['submit'])) {
                    ...
                    $query = "SELECT * FROM payment WHERE status!='' and branch_code like '%" . $_SESSION['branch'] . "%' and date>='".date("Y/m/d")."' and date<='".date("Y/m/d")."'";
                }
