 ...
 <!-- header -->
                <div class="controls">
                    ...
                    <nav class="links">
                        <ul>
                            <li class="nav-li">
                                <a href="bdo_index.php?branch=Pampanga" class="nav-item <?= $lastSegment === 'bdo_index.php' ? 'nav-item-active' : ''?>">
                            ...
                            <li class="nav-li">
                                <a href="bdo_generate_pos.php" class="nav-item <?= $lastSegment === 'bdo_generate_pos.php' ? 'nav-item-active' : ''?>">
                            ...
                            <li class="nav-li">
                                <a href="bdo_for_verification_pos.php" class="nav-item <?= $lastSegment === 'bdo_for_verification_pos.php' ? 'nav-item-active' : ''?>">
