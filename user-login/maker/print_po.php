...
if ($pageWasRefreshed) {
    $con->query("UPDATE payment SET refresh_print_page='1' WHERE payment_id='" . $_GET['payment_id'] . "'");
}
$time = date('H:i');
$con->query("UPDATE payment SET click_print_button='1', printed_time= '{$time}', printed_date='".date('Y/m/d H:i')."' WHERE payment_id='" . $_GET['payment_id'] . "'");
$con->query("UPDATE payment SET printed='1' WHERE payment_id='" . $_GET['payment_id'] . "'");
...
//    echo "<br>";
    ...
    $sql_maker = $con->query("SELECT * FROM users WHERE usertype='3' and user_id='".$_SESSION['user_id']."'");
