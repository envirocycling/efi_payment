...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM payment WHERE status='generated' and (transfer_date >= '$from' and transfer_date <= '$to') and branch_code like '%$_branch%' and bank_code = 'OTHER_BANK'";
} else {
    $query = "SELECT * FROM payment WHERE status = 'generated' and maker_approved_noti = '0' and bank_code = 'OTHER_BANK'";
}
...
$con->query("UPDATE payment SET maker_approved_noti='1' WHERE status='generated' and bank_code = 'OTHER_BANK'");
                    ...
                    <div id="tab-1" class="tab">
                        ...
                        <div class="content-header">
                            ...
                            <div class="content-header__title">
                                ...
                                <span class="content-header__sub-title">Other Bank - Verification Payments</span>
                            </div>

                            <form action="other_for_verification_pos.php" method="POST">
