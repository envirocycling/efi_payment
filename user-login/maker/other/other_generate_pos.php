...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM payment WHERE status='approved' and (date >= '$from' and date <= '$to') and branch_code NOT LIKE '%" . $_SESSION['branch'] . "%' and printed='1' and bank_code = 'OTHER_BANK'";

} else {
    $query = "SELECT * FROM payment WHERE status='approved' and printed='1' and branch_code NOT LIKE '%" . $_SESSION['branch'] . "%' and bank_code = 'OTHER_BANK'";
}
                    ...
                    <div id="tab-1" class="tab">
                        ...
                        <div class="content-header">
                            <div class="content-header__title">
                                ...
                                <span class="content-header__sub-title">Other Bank - Generate Payments</span>
                            </div>

                            <form action="other_generate_pos.php" method="POST">
