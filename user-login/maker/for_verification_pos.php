    ...
    <div id="tab-1" class="tab">
        ...
        <table class="data display datatable" id="example">
            <article>
                ...
                @session_start();
                if (isset($_POST['submit'])) {
                    $query = "SELECT * FROM payment WHERE status='generated' and transfer_date>='" . $_POST['from'] . "' and transfer_date<='" . $_POST['to'] . "' and branch_code like '%" . $_POST['branch'] . "%' and bank_code = 'SBC'";
                } else {
                    $query = "SELECT * FROM payment WHERE status='generated' and maker_approved_noti='0'  and bank_code = 'SBC'";
                }
...
//                    echo "<th>Status</th>";
                ...
                $con->query("UPDATE payment SET maker_approved_noti='1' WHERE status='generated'");
