...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM payment WHERE status='approved' and date>='" . $_POST['from'] . "' and date<='" . $_POST['to'] . "' and branch_code like '%" . $_GET['branch'] . "%' and bank_code = 'OTHER BANK'";
} else {
    $query = "SELECT * FROM payment WHERE status='approved' and branch_code like '%" . $_GET['branch'] . "%' and bank_code = 'OTHER BANK'";
}
...
<div class="tabs">
    <div id="tab-1" class="tab">
        ...
        <h1>Other Bank Payment Orders</h1>
