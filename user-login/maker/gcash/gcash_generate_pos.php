...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM payment WHERE status='approved' and (date >= '$from' and date <= '$to') and printed='1' and bank_code = 'GCASH'";

} else {
    $query = "SELECT * FROM payment WHERE status='approved' and printed='1' and bank_code = 'GCASH'";
}
                ...
                <div class="content">
                    <div id="tab-1" class="tab">
                        ...
                        <div class="content-header">
                            ...
                            <form action="gcash_generate_pos.php" method="POST">
