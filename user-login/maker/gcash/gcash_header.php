...
//Count label data
$queryCountPo = "SELECT * FROM payment WHERE status='approved' and bank_code = 'BDO_MAIN'";
$_resultCountPo = $con->query($queryCountPo);
$resultCountPo = $_resultCountPo->num_rows;

$queryCountPrinted = "SELECT * FROM payment WHERE status='approved' and printed='1' and bank_code = 'BDO_MAIN'";
$_resultCountPrinted = $con->query($queryCountPrinted);
$resultCountPrinted = $_resultCountPrinted->num_rows;

$queryCountGenerated = "SELECT * FROM payment WHERE status='generated' and maker_approved_noti='0' and bank_code = 'BDO_MAIN'";
...
<head>
    <meta charset="utf-8">
    <title>EFI Payment System | G-CASH</title>
    ...
    <script type="text/javascript" src="gcash.js"></script>
</head>
