...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM payment WHERE status='generated' and (transfer_date >= '$from' and transfer_date <= '$to') and branch_code like '%$_branch%' and bank_code = 'GCASH'";
} else {
    $query = "SELECT * FROM payment WHERE status = 'generated' and maker_approved_noti = '0' and bank_code = 'GCASH'";
}
...
$con->query("UPDATE payment SET maker_approved_noti='1' WHERE status='generated' and bank_code = 'GCASH'");
                        ...
                        <div class="content-header">
                            ...
                            <div class="content-header__title">
                                <span class="content-header__title-bdo">
                                    <span class="content-header__title-bdo-blue">G-CASH</span> 
                                </span> 
                                <span class="content-header__title-title">Verification Payment Orders</span>
                            </div>

                            <form action="gcash_for_verification_pos.php" method="POST">
