        ...
        <table class="data display datatable" id="example">
            <article>
                ...
                if (isset ($_POST['submit'])) {
                    $query = "SELECT * FROM payment WHERE status='verified' and branch_code like '%" . $_SESSION['branch'] . "%' and date>='".$_POST['from']."' and date<='".$_POST['to']."'";
                } else {
                    $query = "SELECT * FROM payment WHERE status='verified' and branch_code like '%" . $_SESSION['branch'] . "%'";
                }
