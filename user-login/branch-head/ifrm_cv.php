...
if(isset($_GET['payment_id'])) {
    ...
    if ($rs_payment['status'] == 'approved') {
        ...
        <a href='ifrm_cv.php?cancel_id=<?php echo $rs_payment['payment_id']; ?>' onclick="return confirm('Are you sure you want to cancel this payment?')"><button>Cancel</button>
            ...
            if ($rs_payment['status'] == '') {
                echo "<a href='ifrm_cv.php?approve_id=" . $rs_payment['payment_id'] . "'><button>Approve</button></a> | <a href='ifrm_cv.php?disapprove=" . $rs_payment['payment_id'] . "'><button>Disapprove</button></a>";
            }
        }
        echo "<br><br>";
        echo "</div>";
