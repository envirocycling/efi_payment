...
<body>
    ...
    $sql_payment = $con->query("SELECT * FROM payment WHERE payment_id='" . $_GET['payment_id'] . "'");
    $rs_payment = $sql_payment->fetch_array();
...
//    echo "<br>";
    ...
    $sql_details = $con->query("SELECT * FROM payment_details WHERE payment_id='" . $rs_payment['branch_code'] . "'");
    while ($rs_details = $sql_details->fetch_array()) {
        echo "<tr>";
    ...
    while ($rs_details = $sql_details->fetch_array()) {
        if ($rs_details['adj_price'] != '') {
            echo "<tr>";
            echo "<td width='160' style='vertical-align: top;'>ADD</td>";
            echo "<td width='150' align='right' style='vertical-align: top;'>ADJ</td>";
            echo "<td width='150' align='right' style='vertical-align: top;'></td>";
            echo "<td width='150' align='right' style='vertical-align: top;'>" . number_format($rs_details['adj_amount'],2) . "</td>";
            echo "</tr>";
        }
    }

    $sql_adj = $con->query("SELECT * FROM payment_adjustment WHERE payment_id='" . $rs_payment['branch_code'] . "'");
    while ($rs_adj = $sql_adj->fetch_array()) {
        if ($rs_adj['adj_type'] != "") {
            echo "<tr>";
    ...
    $sql_maker = $con->query("SELECT * FROM users WHERE usertype='3'");
    $rs_maker = $sql_maker->fetch_array();

    $sql_verifier = $con->query("SELECT * FROM users WHERE usertype='2'");
    $rs_verifier = $sql_verifier->fetch_array();

    $sql_approver = $con->query("SELECT * FROM users WHERE usertype='1'");
    $rs_approver = $sql_approver->fetch_array();
    ...
    echo "<b>Prepared By: </b>" . $rs_payment['ap'] . "</td>";
    echo "<td>";
    ...
    echo "<b>Branch Head: </b>" . $rs_payment['signatory'];
    echo "</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>";
    ...
    echo "<b>Maker : </b>" . $rs_maker['initial'] . "-" . strtoupper($rs_maker['firstname']) . " " . strtoupper($rs_maker['lastname']) . "</td>";
    echo "<td>";
    ...
    echo "<b>Autorizer: </b>" . $rs_verifier['initial'] . "-" . strtoupper($rs_verifier['firstname']) . " " . strtoupper($rs_verifier['lastname']) . "</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td colspan='2'>";
    ...
    echo "<b>Approver : </b>" . $rs_approver['initial'] . "-" . strtoupper($rs_approver['firstname']) . " " . strtoupper($rs_approver['lastname']) . "</td>";
    echo "</tr>";
    echo "</table>";
    echo "</td>";
    echo "</tr>";
