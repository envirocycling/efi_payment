            ...
            <div class="c1">
                <div class="controls">
                    <nav class="links">
                        <ul>
                            <li>
                                <a href="index.php" class="">Request for BH Approval <span class="num">
                                        <?php
                            ...
                            <li>
                                <a href="for_verification_pos.php" class="">Approved Fund Transfer<span class="num">
                                        <?php
                                        include('configPhp.php');
                                        $query = "SELECT count(payment_id) FROM payment WHERE status='generated' and branch_code like '%" . $_SESSION['branch'] . "%' and ap_approved_noti='0'";
                                        $result = mysql_query($query);
                                        while ($row = mysql_fetch_array($result)) {
                                            echo $row['count(payment_id)'];
                                        }
                            ...
                            <li>
                                <a href="disapproved_pos.php" class="">Disapproved POs<span class="num">
                                        <?php
                                        include('configPhp.php');
                                        $query = "SELECT count(payment_id) FROM payment WHERE status='disapproved' and branch_code like '%" . $_SESSION['branch'] . "%' and ap_disapproved_noti='0'";
                                        $result = mysql_query($query);
                                        while ($row = mysql_fetch_array($result)) {
                                            echo $row['count(payment_id)'];
                                        }
