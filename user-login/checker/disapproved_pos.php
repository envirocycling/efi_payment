        ...
        <table class="data display datatable" id="example">
            <article>
                ...
                if (isset($_POST['submit'])) {
                    $query = "SELECT * FROM payment WHERE status='disapproved' and date>='" . $_POST['from'] . "' and date<='" . $_POST['to'] . "'";
                } else {
                    $query = "SELECT * FROM payment WHERE status='disapproved'";
                }
                ...
                while ($row = mysql_fetch_array($result)) {
                    ...
                    echo "<td>" . date("M d, Y", strtotime($row['disapproved_date'])) . " " . date("h:i a", strtotime($row['disapproved_time'])) . "</td>";
                    if ($row['status'] == '') {
                        echo "<td>pending</td>";
                    } else {
