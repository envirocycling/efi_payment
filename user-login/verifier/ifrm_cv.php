...
if (isset($_GET['approve_id'])) {
    mysql_query("UPDATE payment SET status='verified' WHERE payment_id='" . $_GET['approve_id'] . "'");
    echo "<script>
...
if ($rs_payment['status'] == 'verified') {
    echo "<a href='ifrm_cv.php?cancel_id=" . $rs_payment['payment_id'] . "'><button>Cancel</button>";
} else {
    if ($rs_payment['status'] == 'generated') {
