        ...
        <table class="data display datatable" id="example">
            <article>
                ...
                if (isset ($_POST['submit'])) {
                    $query = "SELECT * FROM payment WHERE status='proccessed' and date>='".$_POST['from']."' and date<='".$_POST['to']."'";
                } else {
                    $query = "SELECT * FROM payment WHERE status='proccessed' and date>='".date("Y/m/d")."' and date<='".date("Y/m/d")."'";
                }
