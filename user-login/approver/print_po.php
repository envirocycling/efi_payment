...
//    echo "<br>";
    ...
    $sql_maker = mysql_query("SELECT * FROM users WHERE usertype='3'");
    ...
    echo "<b>Verified By: </b>" . $rs_payment['signatory'];
    echo "</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>";
    ...
    echo "<b>Consolidated By: </b>" . $rs_maker['initial'] . "-" . strtoupper($rs_maker['firstname']) . " " . strtoupper($rs_maker['lastname']) . "</td>";
    echo "<td>";
    ...
    echo "<b>Transaction Authorized By: </b>" . $rs_verifier['initial'] . "-" . strtoupper($rs_verifier['firstname']) . " " . strtoupper($rs_verifier['lastname']) . "</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td colspan='2'>";
    ...
    echo "<b>Approved By : </b>" . $rs_approver['initial'] . "-" . strtoupper($rs_approver['firstname']) . " " . strtoupper($rs_approver['lastname']) . "</td>";
    echo "</tr>";
    echo "</table>";
    echo "</td>";
    echo "</tr>";
