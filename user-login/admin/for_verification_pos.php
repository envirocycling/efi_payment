...
<div class="tabs">
    <div id="tab-1" class="tab">
        ...
        <br>
		<a href='generate_pos.php'>Select Many</a>
		<br>
		<br>
...
//                        }
                    echo "<td><a rel='facebox' href='ifrm_cv.php?payment_id=" . $row['payment_id'] . "'><button>View</button></a>";
                     ?>
                     
					 <a rel='facebox' href="reprintremarks.php?id=<?php echo $row['payment_id'];?>"><button>Reprint</button></a> 
					
                   <a href="disapproved.php?id=<?php echo $row['payment_id'];?>"><button onclick="return confirm('Do you want to Disapproved?')";>Disapprove</button></a> 
