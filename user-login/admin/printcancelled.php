...
//    echo "<br>";
	...
	$select = mysql_query("Select * from payment Where payment_id='$id'") or die (mysql_error());
	$select_row = mysql_fetch_array($select);
	$remarks= $select_row['remarks'];
	?>
    <br /><br />
   <center> <img src="images/can.png"  height="90%" style="position:absolute; top:0px; left:0px;">
   <br /><?php echo 'Reason: '.$remarks;?>
   </center>
</body>
