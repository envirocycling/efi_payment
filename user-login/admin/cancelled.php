    ...
    <div id="tab-1" class="tab">
        ...
        <table class="data display datatable" id="example">
            <article>
                ...
                @session_start();
                if (isset($_POST['submit'])) {
                    $query = "SELECT * FROM payment WHERE status LIKE '%cancel%' and date>='" . $_POST['from'] . "' and date<='" . $_POST['to'] . "' and branch_code like '%" . $_POST['branch'] . "%'";
                } else {
                    $query = "SELECT * FROM payment WHERE status LIKE '%cancel%'";
                }
...
//                    }
                    ...
                    ?><a href="printcancelled.php?id=<?php echo $row['payment_id'];?>"><button onclick="return confirm('Do you want to continue?')";>Print(cancelled)</button></a>
					<?php
