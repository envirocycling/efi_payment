            ...
            <div class="c1">
                <div class="controls">
                    <nav class="links">
                        <ul>
                        	<li>
                                <a href="index1.php" class="">Pending For Request POs <span class="num">
                                        <?php
                                        include('configPhp.php');
                                        $query = "SELECT count(payment_id) FROM payment WHERE status=''";
                            ...
                            <li>
                                <a href="index.php" class="">Request for POs <span class="num">
                                        <?php
                                        include('configPhp.php');
                                        $query = "SELECT count(payment_id) FROM payment WHERE status='approved'";
                                        $result = mysql_query($query);
                                        while ($row = mysql_fetch_array($result)) {
                                            echo $row['count(payment_id)'];
                                        }
                             ...
                             <li>
                                <a href="for_verification_pos.php" class="">Generated Fund Transfer<span class="num">
                                        <?php
                                        include('configPhp.php');
                                        $query = "SELECT count(payment_id) FROM payment WHERE status='generated' and maker_approved_noti='0'";
                                        $result = mysql_query($query);
                                        while ($row = mysql_fetch_array($result)) {
                                            echo $row['count(payment_id)'];
                                        }
                                    ...
                                    <li>
                                <a href="cancelled.php" class="">Cancelled<span class="num">
                                        <?php
                                        include('configPhp.php');
                                        $query = "SELECT count(payment_id) FROM payment WHERE status='cancelled' ";
                                        $result = mysql_query($query);
                                        while ($row = mysql_fetch_array($result)) {
                                            echo $row['count(payment_id)'];
                                        }
...
//                            }
                            ...
                            <?php
//                                        include('configPhp.php');
//                                        $query = "SELECT count(payment_id) FROM payment WHERE status='disapproved'";
//                                        $result = mysql_query($query);
//                                        while ($row = mysql_fetch_array($result)) {
//                                            echo $row['count(payment_id)'];
//                                        }
