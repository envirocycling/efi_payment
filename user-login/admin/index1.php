    ...
    <div id="tab-1" class="tab">
        ...
        <table class="data display datatable" id="example">
            <article>
                ...
                @session_start();
                if (isset($_POST['submit'])) {
                    $query = "SELECT * FROM payment WHERE status='' and date>='" . $_POST['from'] . "' and date<='" . $_POST['to'] . "' and branch_code like '%" . $_POST['branch'] . "%'";
                } else {
...
//                    }
                    ...
                    ?><a href="approved.php?id=<?php echo $row['payment_id'];?>"><button onclick="return confirm('Do you want to Approved?')";>Approved</button></a>
					
                   <a href="disapproved.php?id=<?php echo $row['payment_id'];?>"><button onclick="return confirm('Do you want to Disapproved?')";>Disapproved</button></a> <?php
					echo "<a href='cancel.php?id='".$row['payment_id']."'><button>Cancel</button></a>";
                    echo "</td>";
                    echo "</tr>";
                    $ctr++;
                }
