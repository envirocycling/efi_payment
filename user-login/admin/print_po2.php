...
<body onLoad="closes()" >
    ...
    $sql_payment = mysql_query("SELECT * FROM payment WHERE payment_id='$id'");
...
//    echo "<br>";
    ...
    $sql_maker = mysql_query("SELECT * FROM users WHERE usertype='3' and user_id='".$rs_payment['transfer_by']."'");
    ...
    $remarks2 = 'Reprint:  ' . $remarks;
    $timezone = +8;
    $time = gmdate('H:i A', time() + 3600 * ($timezone + date("I")));
    $update = mysql_query("Update payment SET  printed='1', printed_time= '$time', remarks='$remarks2' Where payment_id = '$id'") or die(mysql_error());

    echo "<br /><br />" . "REMARKS:" . "<br />";
    echo $remarks2 . "<br /><br />";
    echo "Verified by:"
    ?>
</body>
