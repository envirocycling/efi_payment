...
$date= gmdate('Y-m-d',time() + 3600*($timezone+date("I")));
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $query = "SELECT * FROM payment WHERE status='generated' and printed='1' and date='$date'";
                    } 
...
//                        }
            ...
            <table>
                ...
                <tr>
                    <td>
					      <input class="radio" type="radio" hidden name="operation" value="1" checked>
                       Remarks: <textarea name="remarks" value="" cols="30" rows="5"></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <button name="submit" onclick="return confirm('All data will mark as proccessed, Once you click the [Ok] you cant undo this action.')">Submit To Cancel</button>
                    </td>
                </tr>
            </table>
        </form>
