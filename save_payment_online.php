...
$rs_num_row = $sql_check->fetch_array();
...
if ($rs_num_row == 0) {
    ...
    $x = $con->query("INSERT INTO `payment`(`branch_code`, `bank_code`, `cheque_no`, `voucher_no`, `cheque_name`, `supplier_name`, `sub_total`, `ts_fee`, `adjustments`, `grand_total`, `type`, `account_name`, `account_number`, `status`, `ap`, `verifier`, `signatory`,`date`,`time`)
